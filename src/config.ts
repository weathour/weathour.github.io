...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/weathour/weathour.github.io", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Weathour",
	bio: "在西安读博，研究无人驾驶。写模型，也写文艺与社会生活；常常小题大做，慢慢筛出些有用的东西。",
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/weathour",
		},
		{
			name: "Email",
